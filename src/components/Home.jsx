     ...
     <div>
       <span className="cross">The</span>
          ...
          <AiOutlineMenu/>
            ...
            <hr className="hr1" />
          <div className="ud">
           <Link to={`/pages/about/${1}`} className="two"><Banner className="jaipur" title={"Kedarnath Temple,located in the Garhwal Himalayan range near the Mandakini river"} tag={"Travel / August 2017" } banimg={require("../imagess/kedharnath.jpg")}/></Link>
          
            <div className="double">
            <Link to={`/pages/about/${2}`} className="two"><Banner titleClass="first1" className="delhi" title={"Badrinath, Town in Uttarakhands"} tag={"Travel / August 2017"} banimg={require("../imagess/badrinath.jpg")} /></Link><br/>
            <Link to={`/pages/about/${3}`} className="two"><Banner titleClass="first1" className="delhi1" title={"Shree Somnath Jyotirlinga Temple"} tag={"Travel / August 2017"} banimg={require("../imagess/somnath.jpg")}/></Link>
            </div>
          </div>
          ...
          <div className="box">
            ...
            <div className="more">
             ...
             <Link to={`/pages/about/${4}`} className="two"><Banner titleClass="gujtext" className="guj" title={"Thiruvananthapuram"} tag={"Travel / Oct 2019"} banimg={require("../imagess/tr.jpg")} /></Link>
            ...
            <div className="boxleft">
               <div className="advert">
                ...
                <div className="toppost">
                    ...
                    <h3 className="top1text">Munnar,Kerala</h3>
                    <span className="travel">Travel</span>
                    <span className="travel1">/ Oct 24 2020</span>
                    </div>
                    </Link>
                    <hr className="hr6" />
                    {
